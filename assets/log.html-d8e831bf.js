import{_ as n,p as s,q as a,Q as t,R as e,t as i,a3 as o}from"./framework-dd056dd6.js";const c={},l=e("h1",{id:"view-commit-log",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#view-commit-log","aria-hidden":"true"},"#"),i(" View Commit Log")],-1),r=o(`<p>Git keeps track of the history of each commit made to the repository. This history is known as the commit log.</p><p>To view the commit log, use <code>git log</code>.</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> log
