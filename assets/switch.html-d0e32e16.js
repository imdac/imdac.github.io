import{_ as c,M as a,p as l,q as p,R as s,t as n,N as e,a3 as i}from"./framework-dd056dd6.js";const r={},d=s("h1",{id:"switch",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#switch","aria-hidden":"true"},"#"),n(" switch")],-1),u=s("h2",{id:"the-switch-statement",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#the-switch-statement","aria-hidden":"true"},"#"),n(" The switch statement")],-1),k={href:"https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/switch",target:"_blank",rel:"noopener noreferrer"},v=s("code",null,"switch",-1),m=s("code",null,"if...else",-1),b=s("code",null,"switch",-1),h=i(`<p>Each <code>case</code> is evaluated to see if it matches the provided expression. A <code>case</code> will only match the expression if the case has the exact same values using the strict comparison (<code>===</code>) operator. If a case does match the expression, the associated block of code will be executed.</p><p>A <code>break</code> statement is used to tell the program to jump out of switch statement and ignore the remaining cases. If a <code>break</code> statement is not used, then fall through will occur.</p><p>Let&#39;s do the same thing we were doing in the if...else examples using a switch statement. With this new statement, we can include all the conditions in the same block of code.</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="the-break-statement" tabindex="-1"><a class="header-anchor" href="#the-break-statement" aria-hidden="true">#</a> The break statement</h2><p>In most cases, it is necessary to include a <code>break</code> at the end of a <code>case</code>. If a <code>break</code> statement is not used then fall through will occur and all remaining cases will be executed. This is because once a <code>switch</code> encounters a matching <code>case</code> all remaining cases are also considered matches.</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// Note that productTotal is $30</span>
<span class="token keyword">switch</span> <span class="token punctuation">(</span><span class="token boolean">true</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">case</span> productTotal <span class="token operator">&lt;</span> <span class="token number">50</span><span class="token operator">:</span>
    <span class="token comment">// this block of code will execute</span>
    cartTotal <span class="token operator">=</span> productTotal <span class="token operator">+</span> shippingFee
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16);function w(g,f){const t=a("ExternalLinkIcon"),o=a("Youtube");return l(),p("div",null,[d,u,s("p",null,[n("The "),s("a",k,[v,n(" statement"),e(t)]),n(" is similar to the "),m,n(" statement, but instead of evaluating a condition, the "),b,n(" statement contains different cases.")]),h,e(o,{id:"I5YlFbIFKGE",citation:"griffith"})])}const y=c(r,[["render",w],["__file","switch.html.vue"]]);export{y as default};
